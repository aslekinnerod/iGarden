...
enum PlantDatabase {
    ...
    static let plants: [PlantInfo] = [
        ...
        p("Monstera", "Monstera deliciosa", 5.5, 6.5, "vindusblad"),
        p("Gullranke", "Epipremnum aureum", 6.0, 6.5, "scindapsus"),
        p("Svigermors tunge", "Sansevieria trifasciata", 5.5, 7.0, "sansevieria", "bajonettplante"),
        p("Fiolinfiken", "Ficus lyrata", 6.0, 7.0),
        p("Gummifiken", "Ficus elastica", 5.5, 7.0, "gummitre"),
        p("Benjaminfiken", "Ficus benjamina", 6.0, 6.5, "bjørkefiken"),
        p("Elefantøre", "Alocasia", 5.5, 6.5, "alokasia"),
        p("Paraplytre", "Schefflera", 6.0, 6.5),
        p("Fredslilje", "Spathiphyllum", 5.5, 6.5),
        p("Grønnrenner", "Chlorophytum comosum", 6.0, 7.0, "grønnlilje", "ampellilje"),
        p("Dragetre", "Dracaena", 6.0, 6.5, "dracena"),
        p("Yucca", "Yucca elephantipes", 6.0, 7.5, "palmelilje"),
        p("Kentiapalme", "Howea forsteriana", 6.0, 7.0),
        p("Arecapalme", "Dypsis lutescens", 6.0, 6.5, "gullpalme"),
        p("Stuepalme", "Chamaedorea elegans", 6.0, 7.0, "bergpalme"),
        p("Philodendron", "Philodendron", 5.5, 6.5),
        p("Calathea", "Calathea", 6.0, 6.5, "bønnemønsterplante"),
        p("Peperomia", "Peperomia", 6.0, 6.6),
        p("Kinesisk pengeplante", "Pilea peperomioides", 6.0, 7.0, "pilea", "misjonærplante"),
        p("Smaragdpalme", "Zamioculcas zamiifolia", 6.0, 7.0, "zz-plante", "zamioculcas"),
        p("Aloe vera", "Aloe barbadensis", 6.5, 8.0),
        p("Kaktus", "Cactaceae", 6.0, 7.0, "ørkenkaktus"),
        p("Sukkulent", nil, 6.0, 7.0, "sukkulenter"),
        p("Orkidé", "Phalaenopsis", 5.5, 6.5, "brudeorkide"),
        p("Flamingoblomst", "Anthurium", 5.5, 6.5),
        p("Voksblomst", "Hoya carnosa", 6.0, 7.0, "hoya", "porselensblomst"),
        p("Tradescantia", "Tradescantia zebrina", 5.5, 6.5, "vandrejøde"),
        p("Bønneplante", "Maranta leuconeura", 5.5, 6.0, "maranta"),
        p("Paradisfuglblomst", "Strelitzia", 5.5, 7.5, "strelitzia"),
        p("Bananplante", "Musa", 5.5, 6.5),
        p("Pengetre", "Crassula ovata", 6.0, 7.0, "jadeplante"),
        p("Flettetre", "Pachira aquatica", 6.0, 7.5, "pachira"),
        p("Fittonia", "Fittonia albivenis", 6.0, 7.0, "nerveplante"),
        p("Stuebregne", "Nephrolepis exaltata", 5.5, 6.5, "sverdbregne"),
        p("Fugleredebregne", "Asplenium nidus", 5.5, 6.5),
        p("Kroton", "Codiaeum variegatum", 6.0, 6.5),
        p("Dieffenbachia", "Dieffenbachia", 6.0, 6.5),
        p("Aglaonema", "Aglaonema", 5.5, 6.5, "silkeplante"),
        p("Hjerte på snor", "Ceropegia woodii", 6.0, 7.5, "hjerteranke"),
        p("Usambarafiol", "Saintpaulia", 5.5, 6.5, "saintpaulia"),
        p("Elefantfot", "Beaucarnea recurvata", 6.0, 7.0),
        p("Sagopalme", "Cycas revoluta", 5.5, 6.5, "konglepalme"),

        // MARK: Blomstrende stueplanter
        p("Julestjerne", "Euphorbia pulcherrima", 5.8, 6.5),
        p("Amaryllis", "Hippeastrum", 6.0, 6.8, "ridderstjerne"),
        p("Alpefiol", "Cyclamen persicum", 5.5, 6.5, "cyclamen"),
        p("Julekaktus", "Schlumbergera", 5.5, 6.5),
        p("Ildtopp", "Kalanchoe blossfeldiana", 6.0, 7.0, "kalanchoe"),
        p("Gerbera", "Gerbera jamesonii", 5.5, 6.5),
        p("Stuejasmin", "Jasminum polyanthum", 6.0, 7.0),

        // MARK: Middelhavsplanter (Hageland-kategori)
        p("Oliventre", "Olea europaea", 6.5, 8.0, "oliven"),
        p("Sitrontre", "Citrus limon", 5.5, 6.5, "sitrus"),
        p("Appelsintre", "Citrus sinensis", 5.5, 6.5, "kalamondin"),
        p("Laurbær", "Laurus nobilis", 6.0, 7.5, "laurbærtre"),
        p("Hamppalme", "Trachycarpus fortunei", 6.0, 7.5, "vifteplame"),
        p("Oleander", "Nerium oleander", 6.5, 7.5),
        p("Bougainvillea", "Bougainvillea", 5.5, 6.5, "trillingblomst"),
        p("Agapanthus", "Agapanthus", 6.0, 7.0, "skjermlilje"),

        // MARK: Hekk og prydgress (tillegg)
        p("Agnbøk", "Carpinus betulus", 6.0, 7.5, "hekkagnbøk"),
        p("Naverlønn", "Acer campestre", 6.0, 7.5),
        p("Rørkvein", "Calamagrostis acutiflora", 5.5, 7.5, "karl foerster"),
        p("Starr", "Carex", 5.5, 7.0, "prydstarr"),
        p("Pampasgress", "Cortaderia selloana", 6.0, 7.5),
        p("Japansk blodgress", "Imperata cylindrica", 5.5, 6.5),

        // MARK: Stauder, løk og sommerblomster (tillegg)
        p("Alunrot", "Heuchera", 6.0, 7.0, "purpurklokke", "heuchera"),
        p("Liljekonvall", "Convallaria majalis", 5.5, 7.0),
        p("Krokosmia", "Crocosmia", 6.0, 7.5, "montbretia"),
        p("Nattlys", "Oenothera", 5.5, 7.0),
        p("Prydkål", "Brassica oleracea (pryd)", 6.0, 7.5, "høstkål"),
        p("Trompetranke", "Campsis radicans", 6.0, 7.5),
        p("Ginkgo", "Ginkgo biloba", 6.0, 7.5, "tempeltre"),
        p("Snøstjerne", "Chionodoxa", 6.0, 7.0, "vårstjerne"),
        p("Prærielilje", "Camassia", 6.0, 7.0),
        p("Million bells", "Calibrachoa", 5.5, 6.5, "småpetunia"),
        p("Bacopa", "Sutera cordata", 5.5, 6.5, "snøflake"),
        p("Melon", "Cucumis melo", 6.0, 7.0),
        p("Sitrongress", "Cymbopogon citratus", 6.0, 7.5),
